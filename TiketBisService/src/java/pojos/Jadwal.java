...
public class Jadwal  implements java.io.Serializable {
     ...
     private Set tikets = new HashSet(0);
    ...
    public Jadwal(String kodeJadwal, Date tanggalBerangkat, Date tanggalSampai, Date jamBerangkat, Date jamSampai, String nomorBus, String terminalAsal, String terminalTujuan, String hargaTiket, Set tikets) {
       this.kodeJadwal = kodeJadwal;
       this.tanggalBerangkat = tanggalBerangkat;
       this.tanggalSampai = tanggalSampai;
       this.jamBerangkat = jamBerangkat;
    ...
    public Set getTikets() {
        return this.tikets;
    }
    
    public void setTikets(Set tikets) {
        this.tikets = tikets;
    }
