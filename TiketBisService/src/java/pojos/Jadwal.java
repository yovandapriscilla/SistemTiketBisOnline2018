...
public class Jadwal  implements java.io.Serializable {
    ...
    public Jadwal(String kodeJadwal, Date tanggalBerangkat, Date tanggalSampai, Date jamBerangkat, Date jamSampai, String nomorBus, String terminalAsal, String terminalTujuan, String hargaTiket, Tiket tiket) {
       this.kodeJadwal = kodeJadwal;
       this.tanggalBerangkat = tanggalBerangkat;
       this.tanggalSampai = tanggalSampai;
       this.jamBerangkat = jamBerangkat;
